...
const getHtml = {
    html: `<div class="page_wrap"><div class="page_code_wrap"><div class="page_code_base w-embed"><style>
:root {
...
.header-navigation-links__item-content {
  margin-bottom: 0px;
}
.container-lg.is--hero {
  padding-top: 4rem;
}
body {
